                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 40px; height: 40px;" class="align-middle">
                            <a href="{{ route('korisnici.izmeni', $user->id) }}" class="btn btn-primary btn-sm py-1 pt-2 pt-2">
                                <span class="bi bi-pencil" style="font-size: 1.2em;"></span>
                            </a>
                        </td>
                        <td style="width: 40px; height: 40px;" class="align-middle">
                            <a href="{{ route('korisnici.obrisi', $user->id) }}" class="btn btn-danger btn-sm py-1 pt-2">
