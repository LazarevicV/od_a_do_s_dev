                        ...
                        @foreach ($familije as $familija)
                            <tr>
                                ...
                                <td class="align-middle btn-cell">
                                    <a href="{{ route('familija.izmeni', $familija->id) }}"
                                        class="btn btn-primary btn-sm py-1 pt-2 pt-2">
                                        <span class="bi bi-pencil"></span>
                                    </a>
                                </td>
                                @if ($familija->objavljen)
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('familija.unpublish', $familija->id) }}"
                                ...
                                @else
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('familija.publish', $familija->id) }}"
                                ...
                                @endif
                                <td class="align-middle btn-cell">
                                    <a href="{{ route('familija.obrisi', $familija->id) }}"
                                        class="btn btn-danger btn-sm py-1 pt-2">
