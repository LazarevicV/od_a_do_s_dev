            ...
            <div class="container-fluid p-0">
                <div class="col-12 d-flex mb-2">
                    <div class="col-6 pe-2 d-flex">
                        <input type="text" name="pretraga" id="pretraga" placeholder="Претражите фонтове" class="border-0 col-10 p-2">
                    ...
                    <div class="col-3 p-0 ps-2">
                        <select name="tezina_id" class="col-12 border-0 rounded-0 bg-white">
                            ...
                            @foreach ($tezine as $tezina)
                                <option value="{{$tezina->id}}">{{ucwords(str_replace("_", " ", $tezina->naziv))}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
...
<style>
    ...
    button[type="submit"] {
        background-color: transparent; display: flex; justify-content: center; border: none; cursor: pointer; padding-top: 0.3em; font-family: inherit; font-size: 24px; color: #ffffff; background-color: #000E75
    }
    ::placeholder {
        color: #D6CFBA;
        opacity: 1;
