...
<div class="container py-5" style="background-color: #EFEBDC">
    ...
    <div class="col-6 mx-auto mb-2">
        <form action="{{ route('font.pretraga') }}" method="POST" class="mb-3" style="display: flex;">
            @csrf
            <div class="container-fluid p-0">
                <div class="col-12 d-flex mb-2">
                    ...
                    <div class="col-3 p-0">
                        <select name="familija" class="col-12 border-0 rounded-0 bg-white" style="height: 100%"> 
                    ...
                    <div class="col-3 p-0 ps-2">
                        <select name="tezina_id" class="col-12 border-0 rounded-0 bg-white" style="height: 100%">
                ...
                <div class="col-12 mb-2">
                    ...
                    @else
                        <textarea name="message" id="previewTextInput" class="border-0 col-12 p-2 text-start"
                            ...
                            onfocus="if(this.value == 'Овде иде текст за тестирање фонтова') { this.value = ''; }"
                            onblur="if(this.value == '') { this.value = 'Овде иде текст за тестирање фонтова'; }"
                            oninput="updatePreviewText()">{{$message}}</textarea>
                    @endif
                </div>
            </div>
        </form>
