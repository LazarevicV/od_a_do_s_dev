            ...
            <div class="container-fluid p-0">
                <div class="col-12 d-flex mb-2">
                    <div class="col-6 pe-2 d-flex">
                        ...
                        <button class="rounded-end col-2" type="submit" style="background-color: transparent; display: flex; justify-content: center; border: none; cursor: pointer; padding-top: 0.3em; font-family: inherit; font-size: 24px; color: #ffffff; background-color: #000E75">
