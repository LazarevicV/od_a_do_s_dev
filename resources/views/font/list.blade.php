                    ...
                    <tbody>
                        @foreach ($fontovi as $font)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('font.unesifile', $font->id) }}"
                                        class="btn btn-link btn-sm py-1 pt-2 add-file-btn">
                                        Додај фајл
                                    </a>
                                </td>
                                <td class="align-middle btn-cell">
                                    <a href="{{ route('font.izmeni', $font->id) }}"
                                ...
                                @if ($font->objavljen)
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('font.unpublish', $font->id) }}"
                                ...
                                @else
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('font.publish', $font->id) }}"
