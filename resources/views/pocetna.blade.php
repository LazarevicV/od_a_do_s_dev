    ...
    <div class="hero">
        ...
        <div class="hero-section container d-flex justify-center align-items-start">
            <div class="hero-left col-7 black">
                ...
                <p>Ако вам недостају ресурси, савети или идеје како да креирате дигитална решења и дигиталне производе користећи ћириличко писмо овај сајт вам може помоћи – да пронађете ресурсе и размените знања потребна да разноврстан свет ћириличког писма представите у дигиталном свету.</p>
            </div>
...
<section>
    <div class="gif-section container d-flex justify-content-between align-items-center gap-4">
        <div class="col-6 gif-left black">
            ...
            <p>Како правити линкове на ћирилици, како програмирати на ћирилици, како пресловљавати? Која готова решења постоје за лакшу израду веб-сајтова на ћирилици?</p>
