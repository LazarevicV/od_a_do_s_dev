                        ...
                        @foreach ($blogovi as $blog)
                            <tr>
                                ...
                                <td class="align-middle btn-cell">
                                    <a href="{{ route('blog.izmeni', $blog->id) }}"
                                ...
                                @if ($blog->objavljen)
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('blog.unpublish', $blog->id) }}"
                                ...
                                @else
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('blog.publish', $blog->id) }}"
                                ...
                                @if ($blog->istaknut)
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('blog.obrisi_istakni', $blog->id) }}"
                                            class="btn btn-warning btn-sm py-1 pt-2">
                                            <span class="bi bi-star"></span>
                                        </a>
                                    </td>
                                @else
                                    <td class="align-middle btn-cell">
                                        <a href="{{ route('blog.istakni', $blog->id) }}"
                                            class="btn btn-info btn-sm py-1 pt-2">
                                            <span class="bi bi-star"></span>
                                        </a>
                                    </td>
                                @endif
